...
import { Splash, Login, Register, WelcomePage1, WelcomePage2, WelcomePage3, Home, DaftarNotifikasi, Tersimpan, Profil, Riwayat, Kategori, KategoriArtikel, DaftarVideo, DaftarDokumen, DaftarArtikel, NavigationBar, PageVideo} from '../pages';
...
const Router = () => {
  return (
        <Stack.Navigator>
            ...
            <Stack.Screen name="Daftar Dokumen" component={DaftarDokumen}/>
